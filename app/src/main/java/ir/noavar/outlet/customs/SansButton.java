...
public class SansButton extends Button {
    ...
    public SansButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        if (!isInEditMode()) setTypeFace();
    }

    @SuppressLint("NewApi")
    public SansButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
